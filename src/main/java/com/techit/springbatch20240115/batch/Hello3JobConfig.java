...
public class Hello3JobConfig {
    ...
    public Job hello3Job(JobRepository jobRepository, Step hello3Step1, Step hello3Step2, Step hello3Step3) {
        Flow flow1 = new FlowBuilder<SimpleFlow>("hello3Step1Flow")
                .start(hello3Step1)
                .build();

        Flow flow2 = new FlowBuilder<SimpleFlow>("hello3Step2Flow")
                .start(hello3Step2)
                .build();

        Flow hello3Flow = new FlowBuilder<SimpleFlow>("hello3Flow")
                .split(new SimpleAsyncTaskExecutor())
                .add(flow1, flow2)
                .end();

        FlowJobBuilder flowJobBuilder = new JobBuilder("hello3Job", jobRepository)
                .start(hello3Flow)
                .next(hello3Step3)
                .end()
